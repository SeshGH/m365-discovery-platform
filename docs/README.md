...
A repeatable demo harness exists to prove:
- multi-worker concurrency
- report collector gating / retry-until-complete behaviour

See:
- `scripts/demo/multi-worker-report-gating.ps1`

Related documentation:
- **[Runs & Jobs](./runs-and-jobs.md)** (includes script usage and expected outcome)
